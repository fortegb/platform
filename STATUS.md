...
> **Decisões técnicas:** fechadas (D-015..D-027); itens `deferred` reabrem no grilling da fase.
...
- [x] A1/#147, A2/#148 closed; pages:sync on close
- [x] A3/#149 grilled + proposed + applied (await close)
