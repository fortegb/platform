...
> **Decisões técnicas:** fechadas (D-015..D-040); itens `deferred` reabrem no grilling da fase.
...
✅ D1–D4 Integrações → D-037..D-040 (posturas + mapa + alvos + webhooks)
→ EM CURSO passo 4: Epic **#146** — restantes (#162–172)
→ PRÓXIMO: #162 — Config: inventário + convenção de nomes de env vars
...
- [ ] **#162 — Config: inventário + convenção de nomes de env vars**
