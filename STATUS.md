...
- [ ] Continuar #197 — refinar `HouseCard.vue` (pedido explícito, ainda em aberto)
- [ ] Depois: `/blog`, `/blog/[slug]`, `/sobre`, `/contato`, `/privacidade`, `/termos` — ainda não auditados nesta leaf
