...
> **Decisões técnicas:** fechadas (D-015..D-031); itens `deferred` reabrem no grilling da fase.
...
→ EM CURSO passo 4: Epic **#146** — restantes (#153–172)
→ PRÓXIMO: #153 — runbook Supabase local (Docker/OrbStack)
...
- [x] B1/#151 Supabase projects closed
- [x] B2/#152 migrations strategy grilled → propose/apply/close

## Próxima sessão

- [ ] **#153 — Runbook Supabase local** (rbo-create-change + grilling)
...
| Doc | Uso |
|-----|-----|
| [ambientes.html](./docs/planning/ambientes.html) | Ambientes + Supabase + migrações (sócios) |
