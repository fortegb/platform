...
- [ ] Sem D-number novo — tudo foi implementação, processo ou higiene de board, nenhuma decisão de arquitetura
...
- [ ] Run `setup_ai` / `dotfiles_update` — as skills `rbo-*` foram corrigidas hoje (`ai-skills` `18c84b3`); confirmar que os symlinks desta máquina pegam a versão nova
