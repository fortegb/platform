# messaging-channel-policy Specification

## Purpose
Defines which channel (WhatsApp vs. Telegram) the platform uses for a given message based on whether an external party is involved, the consent basis for sending it, and how sends are dispatched.
