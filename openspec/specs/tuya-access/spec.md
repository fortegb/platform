# tuya-access Specification

## Purpose
Defines how the platform provisions and revokes temporary physical house access via the Tuya smart lock for guided visits, and how it behaves when that mechanism is unavailable.
