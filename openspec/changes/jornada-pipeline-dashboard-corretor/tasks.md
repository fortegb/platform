...
- [ ] 1.1 D-064 + `DECISIONS.md` mirror — `registro.status` defined as a
...
- [ ] 1.2 `docs/planning/templates/jornada-pipeline-dashboard-corretor.md`
      — enum definition, join-vs-duplicate rationale, HubSpot boundary
- [ ] 1.3 Update `docs/planning/jornadas-plataforma.md` §4.4 — mark
      validated, replace with corrected flow/model detail
- [ ] 1.4 Update `docs/planning/screen-map.md` — mark
      `/corretor/dashboard`, `/corretor/leads` (or `/corretor/clientes`)
      validated
