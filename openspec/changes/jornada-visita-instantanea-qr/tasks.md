...
- [x] 1.1 D-059 + `DECISIONS.md` mirror — same D-052/D-053 corrections as
...
- [x] 1.2 `docs/planning/templates/jornada-visita-instantanea-qr.md` —
      journey contract detail (OTP flow, ceiling mechanism, boundary with
      #186/#192/#140)
- [x] 1.3 Update `docs/planning/jornadas-plataforma.md` §3.3 — mark
