...
- [ ] 1.1 D-061 + `DECISIONS.md` mirror — magic-link self-service
...
- [ ] 1.2 `docs/planning/templates/jornada-pos-visita-reengajamento.md` —
      link mechanism detail, status lifecycle addition, consent
      classification table
- [ ] 1.3 Update `docs/planning/jornadas-plataforma.md` §3.2 — replace
      ...
      status
- [ ] 1.4 Update `docs/planning/screen-map.md` — add the new
