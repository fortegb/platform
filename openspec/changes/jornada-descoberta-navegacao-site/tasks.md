...
- [ ] 1.1 D-057 + `DECISIONS.md` mirror — lead capture on both WhatsApp CTA
...
- [ ] 1.2 `docs/planning/templates/jornada-descoberta-site.md` — lead-capture
      contract detail (beacon payload shape, `fonte` values, fire-and-forget
      rationale)
- [ ] 1.3 Update `docs/planning/jornadas-plataforma.md` §3.1 — mark
      validated (remove implicit rascunho status), add the lead-capture
      contract note
- [ ] 1.4 Update `docs/planning/screen-map.md` — clear the
