...
- **Epic [#146](https://github.com/fortegb/platform/issues/146):** A1–A4 + B1–B3 (Supabase + migrações + runbook local) feitos; próximo = seed/LGPD ([#154](https://github.com/fortegb/platform/issues/154)).
- **Ambientes:** [página Ambientes](./ambientes.html) — tiers, Vercel, domínios, Supabase, migrações e **runbook local**.

## Concluído recentemente

- **B3 Runbook local** ([#153](https://github.com/fortegb/platform/issues/153)) — D-032 (OrbStack; docs only).
...
1. **Arquitetura** ([#146](https://github.com/fortegb/platform/issues/146)) — seed/test data + LGPD ([#154](https://github.com/fortegb/platform/issues/154)).
...
- No laptop: Supabase local via Docker (OrbStack preferido no Mac); passo a passo técnico no template do repositório.
