...
> Nomes canônicos das variáveis de ambiente. **Docs only** — sem valores; scoping → [`env-scoping.md`](./env-scoping.md) (D-042); acesso → [`secrets-access.md`](./secrets-access.md) (D-043); exemplo → [`env-example.md`](./env-example.md) (D-044).
...
| [`env-example.md`](./env-example.md) (D-044 / #165) | `.env.example` + SETUP-CREDENTIALS |

## Relação

- [`env-scoping.md`](./env-scoping.md) (D-042) · [`secrets-access.md`](./secrets-access.md) (D-043) · [`env-example.md`](./env-example.md) (D-044) · [`environments.md`](./environments.md) · Ambientes
