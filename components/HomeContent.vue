      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div class="text-center">
            ...
            <h3 class="text-base md:text-lg font-semibold mb-1">Segurança</h3>
            <p class="text-sm text-base-content/70">
              Sua casa como você sonha,<br>de nossa família para a sua
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-base md:text-lg font-semibold mb-1">Parceria</h3>
            <p class="text-sm text-base-content/70">
              Direto com quem decide,<br>apoiando você em cada etapa
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-base md:text-lg font-semibold mb-1">Solidez</h3>
            <p class="text-sm text-base-content/70">
              Construção e acabamento superiores,<br>sempre fiel ao projeto
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="py-10 bg-gradient-to-r from-primary-500 to-primary-700 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <NuxtLink
            to="/contato"
            class="w-44 inline-flex items-center justify-center bg-white text-primary-500 px-5 py-2 rounded-lg text-sm font-semibold hover:bg-opacity-90 transition-colors"
          >
            Enviar Mensagem
          </NuxtLink>
        </div>
