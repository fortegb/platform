<template>
  <section class="relative min-h-[400px] md:min-h-[320px] py-12 flex items-center justify-center bg-gradient-to-r from-primary-500 to-primary-700 text-white">
    <div 
    ...
    <div class="container mx-auto px-4 relative z-10 text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center">
        <a 
          ...
          class="inline-flex items-center justify-center gap-2 bg-[#3E8E5E] text-white hover:bg-[#34784F] px-5 py-2 rounded-lg text-sm font-semibold transition-colors"
        >
