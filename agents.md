...
> **A espinha do projeto é o [Roteiro](./docs/planning/roteiro.md)** — 9 passos em 3 estágios (Definição 1–7 · Execução 8 · Evolução 9), com gates G1/G2/G3. É **controlador**, não decorativo, e é representado no board (campo `Etapa` + `Milestone` + tipo nativo), não em prosa. **Passo 4 Arquitetura fechado** — infra/ambientes (#146) e arquitetura de domínio (#179: visitas, mensageria, RBAC, admin) ambos fechados. **Passo 5 Jornadas fechado** — epic #176, todas as 11 leaves concluídas (#185–#195, D-057..D-067). **Passo atual: 6 Design system**. Ver `roteiro.md` antes de escolher trabalho.
