...
export const mockHouses = [
  {
    ...
    features: [
      ...
      { text: 'Projeto de decoração completo — cozinha, área gourmet e banheiros já mobiliados; demais ambientes com projeto pronto para o comprador executar', grupo: 'destaque' as const },
